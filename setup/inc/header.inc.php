...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?bdfece3">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?bdfece3"></script>
    <script type="text/javascript" src="js/tips.js?bdfece3"></script>
    <script type="text/javascript" src="js/setup.js?bdfece3"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
