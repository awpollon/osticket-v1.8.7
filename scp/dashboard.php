...
<script type="text/javascript" src="js/raphael-min.js?bdfece3"></script>
<script type="text/javascript" src="js/g.raphael.js?bdfece3"></script>
<script type="text/javascript" src="js/g.line-min.js?bdfece3"></script>
<script type="text/javascript" src="js/g.dot-min.js?bdfece3"></script>
<script type="text/javascript" src="js/bootstrap-tab.js?bdfece3"></script>
<script type="text/javascript" src="js/dashboard.inc.js?bdfece3"></script>

<link rel="stylesheet" type="text/css" href="css/bootstrap.css?bdfece3"/>
<link rel="stylesheet" type="text/css" href="css/dashboard.css?bdfece3"/>
